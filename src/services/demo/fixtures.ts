...
> = [
  ["11632", "Malik Nabers", "WR", "NYG", 23.0, 8, 6],
  ["11604", "Brock Bowers", "TE", "LV", 23.6, 12, 13],
  ["9509", "Bijan Robinson", "RB", "ATL", 24.5, 4, 8],
  ["9488", "Jaxon Smith-Njigba", "WR", "SEA", 24.4, 13, 20],
  ["11560", "Caleb Williams", "QB", "CHI", 24.7, 15, 1],
  ["11620", "Rome Odunze", "WR", "CHI", 24.1, 19, 9],
  ["8130", "Trey McBride", "TE", "ARI", 26.7, 20, 55],
  ["8137", "George Pickens", "WR", "DAL", 25.4, 24, 52],
  ["8151", "Kenneth Walker III", "RB", "KC", 25.7, 28, 41],
  ["8112", "Drake London", "WR", "ATL", 25.0, 22, 8],
  ["7564", "Ja'Marr Chase", "WR", "CIN", 26.4, 1, 5],
  ["8155", "Breece Hall", "RB", "NYJ", 25.2, 18, 36],
  ["11566", "Jayden Daniels", "QB", "WAS", 25.6, 7, 2],
  ["11631", "Brian Thomas Jr.", "WR", "JAX", 23.8, 10, 23],
  ["11624", "Xavier Worthy", "WR", "KC", 23.3, 26, 28],
  ["11584", "Bucky Irving", "RB", "TB", 24.1, 34, 125],
  ["11628", "Marvin Harrison Jr.", "WR", "ARI", 23.9, 16, 4],
  ["11589", "Trey Benson", "RB", "ARI", 24.0, 42, 66],
...
const recentPicks = [
  ["11584", "Grid Iron Giants"],
  ["11624", "Fantasy Phantoms"],
  ["11631", "Touchdown Terrors"],
  ["11566", "4th & Future"],
  ["11589", "The Rebuilders"],
  ["11628", "Dynasty or Bust"],
] as const;
